...
🍱 Support `taxa="plants"` in `bionty.Gene` [PR](https://github.com/laminlabs/bionty/pull/153) [@mossjacob](https://github.com/mossjacob) [@Zethson](https://github.com/Zethson)

```python
bt.Gene(organism="arabidopsis thaliana", version="release-57", taxa="plants").source.df()
```
