...
- 💄 A `ULabels` page [@adamdev21](https://github.com/adamdev21)
- 🚸 Show only latest versions of versioned entities & add a version drop down to `Artifact` & `Collection` in analogy to `Transform` [@adamdev21](https://github.com/adamdev21) [@chaichontat](https://github.com/chaichontat)
...
- ✨ SSO login with corresponding API key [@Koncopd](https://github.com/Koncopd) [@chaichontat](https://github.com/chaichontat) [@sunnyosun](https://github.com/sunnyosun)
