...
## 2024-11-19 {small}`db 0.76.17 | bionty 0.53.0`
...
- ⚡️ Improve truncated searches [PR](https://github.com/laminlabs/lamindb/pull/2183) [@Koncopd](https://github.com/Koncopd)
- 🚚 Rename `import_from_source` to `import_source` [PR](https://github.com/laminlabs/bionty/pull/150) [@Zethson](https://github.com/Zethson)
