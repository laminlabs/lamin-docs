...
- ✨ Allow filtering `.obs` indices in `MappedCollection` [PR](https://github.com/laminlabs/lamindb/pull/1974) [@Koncopd](https://github.com/Koncopd)
...
- 🍱 [Use case for curating perturbations](https://docs.lamin.ai/perturbation) [PR](https://github.com/laminlabs/lamin-usecases/pull/142) [@Zethson](https://github.com/Zethson)
