...
## 2024-12-16 {small}`db 0.77.3`

- ✨ Add `Curator.from_tiledbsoma()` [PR](https://github.com/laminlabs/lamindb/pull/2228) [@Koncopd](https://github.com/Koncopd)
- ✨ Add an artifact loader for `.yaml` [PR](https://github.com/laminlabs/lamindb/pull/2270) [@Koncopd](https://github.com/Koncopd)
- 🎨 Better names for sections in `.describe()` [PR1](https://github.com/laminlabs/lamindb/pull/2247) [PR2](https://github.com/laminlabs/lamindb/pull/2259) [@sunnyosun](https://github.com/sunnyosun)
- 🚸 Improve feedback on not-up-to-date notebook content [PR](https://github.com/laminlabs/lamindb/pull/2284) [@falexwolf](https://github.com/falexwolf)
- 🚸 Log tiledbsoma target path [PR](https://github.com/laminlabs/lamindb/pull/2278) [@Koncopd](https://github.com/Koncopd)
...
- 🐛 Fix display of (non-categorical) `str` features in `.describe()` [PR](https://github.com/laminlabs/lamindb/pull/2253) [@sunnyosun](https://github.com/sunnyosun)
...
## 2024-12-02 {small}`R 0.3.0`

- ✨ Add `Artifact$open()` to stream array-like artifacts [PR](https://github.com/laminlabs/laminr/pull/117) [@lazappi](https://github.com/lazappi)
- ✨ Track artifacts as inputs [PR](https://github.com/laminlabs/laminr/pull/124) [@lazappi](https://github.com/lazappi)
...
- 🚸 Improve UX of `db$track()` and `db$finish()` [PR](https://github.com/laminlabs/laminr/pull/120) [@lazappi](https://github.com/lazappi) [@falexwolf](https://github.com/falexwolf)

## 2024-12-01 {small}`db 0.77.2`

- 🚸 A more intuitive `artifact.describe()` [PR](https://github.com/laminlabs/lamindb/pull/2236) [@sunnyosun](https://github.com/sunnyosun)
- ✨ Enable to easily join features onto artifacts via `Artifact.df()` [PR](https://github.com/laminlabs/lamindb/pull/2238) [@falexwolf](https://github.com/falexwolf)
- ✨ Support features with `dtype = 'str'` [PR](https://github.com/laminlabs/lamindb/pull/2226) [@falexwolf](https://github.com/falexwolf)
- ✨ Support features with `dtype = 'datetime'` and improve feature values handling [PR](https://github.com/laminlabs/lamindb/pull/2218) [@falexwolf](https://github.com/falexwolf)
...
- 🎨 Add `.standardize()` to `Curator` [PR](https://github.com/laminlabs/lamindb/pull/2186) [@sunnyosun](https://github.com/sunnyosun)
- 🎨 Make search in `bionty.base` consistent with lamindb [PR](https://github.com/laminlabs/lamindb/pull/2205) [@Koncopd](https://github.com/Koncopd)

## 2024-11-25 {small}`hub 0.31`

🚸 Improve speed and relevance search. Make search consistent with `lamindb` 0.77. [PR](https://github.com/laminlabs/laminhub-public/pull/26) [@Koncopd](https://github.com/Koncopd) [@fredericenard](https://github.com/fredericenard)
...
Search results for `lamindb` and `bionty` are now exemplified here [faq/search](faq/search).
...
- 🐛 Fixed incorrect sorting in the version selector [@chaichontat](https://github.com/chaichontat)
...
## 2024-11-21 {small}`db 0.77.0 | bionty 0.53`
...
- 📝 Add guide on gene symbol mapping [Guide](faq/symbol-mapping) [PR](https://github.com/laminlabs/lamindb/pull/2134) [@Zethson](https://github.com/Zethson)
...
## 2024-10-18 {small}`db 0.76.14 | bionty 0.52`
...
## 2024-10-08 {small}`db 0.76.12 | bionty 0.51`
...
## 2024-09-18 {small}`db 0.76.7 | bionty 0.50`
...
🏗️ Bionty is now a single Python package. [PR](https://github.com/laminlabs/bionty/pull/17)

- 🏗️ `lnschema-bionty` and `bionty-base` are integrated into `bionty`
- 🚸 Considerably simpler UX

⚠️ Migration: Once you connect to an instance, you'll be asked to uninstall `lnschema_bionty` and `lamin migrate deploy`
...
- ✨ Add ICD ontology for `Disease` [PR](https://github.com/laminlabs/bionty-base/pull/538) [PR](https://github.com/laminlabs/bionty-base/pull/554) [Zethson](https://github.com/Zethson)
...
- ✨ Manage multiple storage locations with integrity & introduce `keep_artifacts_local` [PR](https://github.com/laminlabs/lamindb/pull/1611) [@falexwolf](https://github.com/falexwolf)
...
Name | PR | Developer | Date | Version
--- | --- | --- | --- | ---
🚚 Rename `Bionty` to `PublicOntology` class | [536](https://github.com/laminlabs/bionty-base/pull/536) | [sunnyosun](https://github.com/sunnyosun) | 2024-01-12 | 0.36.0
