...
- 🎨 Remove backward relationship to `Run`, `User` & `Source` [PR](https://github.com/laminlabs/lamindb/pull/1910) [PR](https://github.com/laminlabs/bionty/pull/105) [@falexwolf](https://github.com/falexwolf) [@sunnyosun](https://github.com/sunnyosun)
