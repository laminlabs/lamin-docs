...
✨ Improved search speed and relevance [@Koncopd](https://github.com/Koncopd). The minimum search query is also now 3 characters, enabling gene name searching.

<img width="944" alt="image" src="https://github.com/user-attachments/assets/6bec75f4-1d61-4a75-b16b-96918b84bede">
