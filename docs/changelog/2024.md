...
- ✨ Allow filtering `.obs` indices in `MappedCollection` [Guide](/scrna-dataloading.ipynb#create-a-map-style-dataset) [PR](https://github.com/laminlabs/lamindb/pull/1974) [@Koncopd](https://github.com/Koncopd)
