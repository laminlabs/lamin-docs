...
A first production-ready version of `laminr`, an R client for LaminDB.

You can read and write data from R as documented at [laminr.lamin.ai](https://laminr.lamin.ai).
