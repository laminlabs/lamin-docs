- 🔖  Release v1.2.0 [PR](https://github.com/laminlabs/laminr/pull/225) [@lazappi](https://github.com/lazappi)
- 🐛 Improve suffix matching in `load_file()` [PR](https://github.com/laminlabs/laminr/pull/231) [@lazappi](https://github.com/lazappi)
- 🚸 Replace CLI functions with `lamin_cli` [PR](https://github.com/laminlabs/laminr/pull/229) [@lazappi](https://github.com/lazappi)
