- 🐛 Use `access_token` in `get_default_bucket_for_instance` in `init_storage` [PR](https://github.com/laminlabs/lamindb-setup/pull/1331) [@Koncopd](https://github.com/Koncopd)
