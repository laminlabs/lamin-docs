...
🍱 The protein ontology has been updated with 9 new organisms from Uniprot. [PR](https://github.com/laminlabs/bionty/pull/371) [@sunnyosun](https://github.com/sunnyosun) [@ishitajain9717](https://github.com/ishitajain9717)

:::{dropdown} ⚠️ Run `bionty.core.sync_public_sources()`

The protein ontology has been updated with 9 new organisms from Uniprot. This will update the `Source` registry with the new organisms of `Protein`.
