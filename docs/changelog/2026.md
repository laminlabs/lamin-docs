...
- 🔊 Give more information on failing to insert an instance record into central during instance initialization [PR](https://github.com/laminlabs/lamindb-setup/pull/1283) [@Koncopd](https://github.com/Koncopd)
...
- 🐛 Fix initializing an instance with the db parameter passed [PR](https://github.com/laminlabs/lamindb/pull/3524) [@Koncopd](https://github.com/Koncopd)
