...
- 🐛 Fix type annotation of `SQLRecord.filter()` to be LaminDB's `QuerySet`, not Django's [PR](https://github.com/laminlabs/lamindb/pull/3719) [@falexwolf](https://github.com/falexwolf)
