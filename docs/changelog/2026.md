...
- 🐛 Keep audit logs available when actor names fail to load [PR](https://github.com/laminlabs/laminhub-public/pull/416) [@chaichontat](https://github.com/chaichontat)

## 2026-09-22 {small}`hub 1.58.0`

- ✨ PDF previewer for artifacts [PR](https://github.com/laminlabs/laminhub-public/pull/408) [@sheetalgiri](https://github.com/sheetalgiri)
...
- ✨ Add feature filters to record page filtering [PR](https://github.com/laminlabs/laminhub-public/pull/414) [@sheetalgiri](https://github.com/sheetalgiri)
- 🚚 Rename "Sheet" to "Record frame" [PR](https://github.com/laminlabs/laminhub-public/pull/413) [@falexwolf](https://github.com/falexwolf)

## Soon {small}`db 2.11.0`

Highlights:

- ✨ Introduce `worktree` mode inspired by `git`'s `worktree` behavior [PR](https://github.com/laminlabs/lamindb/pull/3895) [@Koncopd](https://github.com/Koncopd) [@falexwolf](https://github.com/falexwolf)
- ✨ Track Cursor IDE sessions [PR](https://github.com/laminlabs/lamindb/pull/3911) [@Ebad371](https://github.com/Ebad371)
- ✨ Qualify backward relationships among features and storing feature valus in diverse fields of `Record` [PR](https://github.com/laminlabs/lamindb/pull/3910) [@falexwolf](https://github.com/falexwolf)
...
- ✨ Allow scoping `schema.itype` to a `Feature` type [PR](https://github.com/laminlabs/lamindb/pull/3889) [@ishitamjain](https://github.com/ishitamjain)
...
- 🚸 Enable calling `key_is_virtual` in `lightning` checkpoint [PR](https://github.com/laminlabs/lamindb/pull/3873) [@jorenretel](https://github.com/jorenretel)
...
- 🚸 Adjust run tracking permisison handling [PR](https://github.com/laminlabs/lamindb/pull/3879) [@Koncopd](https://github.com/Koncopd)
...
- 🚸 Warn when expiration of the API key is within 7 days [PR](https://github.com/laminlabs/lamindb-setup/pull/1389) [@Koncopd](https://github.com/Koncopd)
- 🚸 Add `--store-kwargs` to `lamin load` and `lamin save` [PR](https://github.com/laminlabs/lamin-cli/pull/282) [@Koncopd](https://github.com/Koncopd)
...
- 🚸 Do not show tracebacks for all API key errors [PR](https://github.com/laminlabs/lamin-cli/pull/287) [@Koncopd](https://github.com/Koncopd)
...
- 🐛 Validate the `SQLRecord` type if passing an object directly in `FeatureManager.add_values()` [PR](https://github.com/laminlabs/lamindb/pull/3890) [@ishitajain9717](https://github.com/ishitajain9717)
- 🐛 In `artifact.describe()`, correctly deal with datasets that exceed the maximum number of preview features [PR](https://github.com/laminlabs/lamindb/pull/3885) [@falexwolf](https://github.com/falexwolf)
...
## 2026-09-15 {small}`hub 1.56.0`

- ✨ Allow branch selection to include main [PR](https://github.com/laminlabs/laminhub-public/pull/412) [@chaichontat](https://github.com/chaichontat)
...
- 💄 Make Records the default first tab and move Overview all the way to the right [PR](https://github.com/laminlabs/laminhub-public/pull/410) [@falexwolf](https://github.com/falexwolf)

## 2026-09-08 {small}`hub 1.55.0`
...
- 🐛 Fix branch selector behavior on record subtype pages [PR](https://github.com/laminlabs/laminhub-public/pull/409) [@chaichontat](https://github.com/chaichontat)

## 2026-09-07 {small}`blog`

- 📝 Extracting single-cell morphology and subcellular protein localisation from Xenium data with scPortrait [PR](https://github.com/laminlabs/lamin-blog/pull/61) [@nik-as](https://github.com/nik-as)

## 2026-09-01 {small}`hub 1.54.0`
...
## 2026-08-27 {small}`hub 1.53.0`

- 🚸 Support a broad range of data types for launchable functions [PR](https://github.com/laminlabs/laminhub-public/pull/401) [@chaichontat](https://github.com/chaichontat)
- 🚸 Under the `Records` tab, rename `Type` to `Page` so that pure UI users don't have to learn the concept of a record type [PR](https://github.com/laminlabs/laminhub-public/pull/404) [@sheetalgiri](https://github.com/sheetalgiri)

## 2026-08-26 {small}`db 2.10.0`

⚠️ `lamin init` now creates a database with `dev-dir` in the current directory, analogous to `git`; if not passing `--storage`, the default storage location is now `./storage/` [PR](https://github.com/laminlabs/lamindb/pull/3864) [@falexwolf](https://github.com/falexwolf)

:::{dropdown} What was the behavior before?
...
- ✨ Add `lamin settings mount` to mount storage locations read-only, for example, FUSE [PR](https://github.com/laminlabs/lamin-cli/pull/257) [@jpfeuffer](https://github.com/jpfeuffer)
- ✨ Allow moving artifacts across managed storage locations [PR](https://github.com/laminlabs/lamindb/pull/3842) [@Koncopd](https://github.com/Koncopd)

API:

- 🚸 Delete the `dev-dir` marker upon deleting a database [PR](https://github.com/laminlabs/lamindb-setup/pull/1386) [@falexwolf](https://github.com/falexwolf)
...
- 🚸 Validate type annotations in functions that are decorated with `@ln.flow()` or `@ln.step()` [PR](https://github.com/laminlabs/lamindb/pull/3857) [@falexwolf](https://github.com/falexwolf)
...
- 🚸 Consistent API for saving to non-default databases via the `using` argument in `ln.save()` & `BaseSQLRecord.save()` [PR](https://github.com/laminlabs/lamindb/pull/3852) [@falexwolf](https://github.com/falexwolf)
...
- 🚸 Make the default child record space consistent with the UI behavior [PR](https://github.com/laminlabs/lamindb/pull/3844) [@sunnyosun](https://github.com/sunnyosun)
- 🚸 If a path inside a folder-like artifact is passed to `Artifact()`, return the existing folder-like artifact [PR](https://github.com/laminlabs/lamindb/pull/3855) [@Koncopd](https://github.com/Koncopd)
...
- 🚸 Speed up `BasicQuerySet.first()` [PR](https://github.com/laminlabs/lamindb/pull/3859) [@Koncopd](https://github.com/Koncopd)

Performance:

- ⚡️ Speed up `lamin init` by avoiding network calls for local databases [PR](https://github.com/laminlabs/lamindb-setup/pull/1387) [@falexwolf](https://github.com/falexwolf)
...
- 🐛 In `git` integration, allow finding objects in merge commits [PR](https://github.com/laminlabs/lamindb/pull/3861) [@ishitajain9717](https://github.com/ishitajain9717)
- 🐛 Do not launch implicit queries inside an atomic block after a failure [PR](https://github.com/laminlabs/lamindb/pull/3863) [@Koncopd](https://github.com/Koncopd)
- 🐛 Correctly process anonymous `gs` requests in `Artifact()` [PR](https://github.com/laminlabs/lamindb/pull/3856) [@Koncopd](https://github.com/Koncopd)

Dependencies:

- ⬆️ Add compatibility for `pandas >= 3` [PR](https://github.com/laminlabs/lamindb/pull/3848) [@Koncopd](https://github.com/Koncopd)

## 2026-08-10 {small}`hub 1.52.0`

- ✨ Show spaces in feature lists [PR](https://github.com/laminlabs/laminhub-public/pull/399) [@chaichontat](https://github.com/chaichontat)
...
- 🐛 Fix record search on the database writes page [PR](https://github.com/laminlabs/laminhub-public/pull/395) [@chaichontat](https://github.com/chaichontat)

## 2026-08-07 {small}`nf 0.9.0`
...
- ✨ Allow annotating artifacts [PR](https://github.com/laminlabs/nf-lamin/pull/159) [@rcannood](https://github.com/rcannood)
...
## 2026-08-03 {small}`db 2.9.0`

:::{dropdown} ⚠️ Run `lamin migrate deploy`

🗃️ Add fields: `Schema.suffix` and `Collection.schema`; more stringent unique constraints when `feature is NULL` [PR](https://github.com/laminlabs/lamindb/pull/3814) [PR](https://github.com/laminlabs/lamindb/pull/3813) [PR](https://github.com/laminlabs/lamindb/pull/3815) [@falexwolf](https://github.com/falexwolf)
...
For details see the [Compatibility Matrix](https://docs.lamin.ai/setup#compatibility-matrix) and the [source code](https://github.com/laminlabs/lamindb/tree/main/lamindb/migrations).
...
- ✨ Enable registering http directories as artifacts, with correct hashes & sizes [PR](https://github.com/laminlabs/lamindb-setup/pull/1374) [@Koncopd](https://github.com/Koncopd)

API:

- 🚸 Deprecate `Schema.add_optional_feature()` in favor of `Schema.add()` [PR](https://github.com/laminlabs/lamindb/pull/3822) [@falexwolf](https://github.com/falexwolf)
...
- 🗃️ Add field `.schema` to `Collection`, parallel to `Artifact` and `Record` [PR](https://github.com/laminlabs/lamindb/pull/3813) [@falexwolf](https://github.com/falexwolf)
...
- 🐛 Fix error on large uploads and lacking progress print for `gcsfs` [PR](https://github.com/laminlabs/lamindb/pull/3832) [PR](https://github.com/laminlabs/lamindb-setup/pull/1375) [@Koncopd](https://github.com/Koncopd)
...
## 2026-08-03 {small}`hub 1.51.0`

- ✨ Show validating schemas on collection pages [PR](https://github.com/laminlabs/laminhub-public/pull/393) [@chaichontat](https://github.com/chaichontat)
...
## 2026-07-30 {small}`atlas`

- 🍱 Add atlas `1000genomes` [PR](https://github.com/laminlabs/lamin-usecases/pull/252)
- 🍱 Add EWAS Data Hub [PR](https://github.com/laminlabs/lamin-usecases/pull/251)

## 2026-07-20 {small}`hub 1.50.0`

- ✨ Add scalar feature filters to artifact lists [PR](https://github.com/laminlabs/laminhub-public/pull/390) [@chaichontat](https://github.com/chaichontat)
...
- 🚸 Display schema information for collections [PR](https://github.com/laminlabs/laminhub-public/pull/392) [@falexwolf](https://github.com/falexwolf)
...
## 2026-07-17 {small}`hub 1.49.0`

- ✨ Add drag-and-drop uploads to the markdown editor [PR](https://github.com/laminlabs/laminhub-public/pull/388) [@sheetalgiri](https://github.com/sheetalgiri)
...
- 🐛 Fix project hierarchy navigation, search, and metadata [PR](https://github.com/laminlabs/laminhub-public/pull/385) [@chaichontat](https://github.com/chaichontat)
...
## 2026-07-17 {small}`db 2.8.1`

- 🚸 Support parallel Claude Code sessions and prettify agent traces [PR](https://github.com/laminlabs/lamindb/pull/3805) [@Ebad371](https://github.com/Ebad371)
...
- 📝 Clearer `acid.md` doc [PR](https://github.com/laminlabs/lamindb/pull/3807) [@falexwolf](https://github.com/falexwolf)
- 📝 Clearer organization of system `design.md` doc [PR](https://github.com/laminlabs/lamindb/pull/3809) [@falexwolf](https://github.com/falexwolf)

## 2026-07-13 {small}`hub 1.48.0`
...
## 2026-07-13 {small}`db 2.8.0`

Features:

- ✨ Track Claude Code sessions [PR](https://github.com/laminlabs/lamindb/pull/3801) [@Ebad371](https://github.com/Ebad371)
...
- 🚸 More strictly enforce `CanonicalSuffix` [PR](https://github.com/laminlabs/lamindb/pull/3784) [@Koncopd](https://github.com/Koncopd) [@falexwolf](https://github.com/falexwolf)
...
- 🚸 Merge branches without requiring global branch switch [PR](https://github.com/laminlabs/lamindb/pull/3781) [@sheetalgiri](https://github.com/sheetalgiri)
- 🚸 Actually label reverse accessor for `output_transforms` [PR](https://github.com/laminlabs/lamindb/pull/3783) [@falexwolf](https://github.com/falexwolf)
- 🚸 Add `to_artifact()` to `RecordSet` [PR](https://github.com/laminlabs/lamindb/pull/3780) [@falexwolf](https://github.com/falexwolf)
- 🚸 Fix type annotations of `@strict_classmethod` and `@instance_or_classmethod` [PR](https://github.com/laminlabs/lamindb/pull/3794) [@falexwolf](https://github.com/falexwolf)
...
- 🚸 Add and use `SetupSettings.is_configured` [PR](https://github.com/laminlabs/lamindb-setup/pull/1362) [@Koncopd](https://github.com/Koncopd)
- 🚸 Handle reports of erroring runs in `@ln.flow()` better [PR](https://github.com/laminlabs/lamindb/pull/3789) [@falexwolf](https://github.com/falexwolf)

CLI:

- 🚸 Speed up and prettify output of `lamin list branch` [PR](https://github.com/laminlabs/lamin-cli/pull/235) [@falexwolf](https://github.com/falexwolf)
...
- 📝 Dedicated agent skills via https://github.com/laminlabs/lamin-skills [PR](https://github.com/laminlabs/lamindb/pull/3790) [@falexwolf](https://github.com/falexwolf)
...
## 2026-07-10 {small}`hub 1.47.0`

- ✨ Versioned notes as in LaminDB [PR](https://github.com/laminlabs/laminhub-public/pull/381) [@chaichontat](https://github.com/chaichontat)
...
- ✨ Support URL dtype [PR](https://github.com/laminlabs/laminhub-public/pull/379) [@chaichontat](https://github.com/chaichontat)
- ⚡️ Speed up scrolling in wide record tables [PR](https://github.com/laminlabs/laminhub-public/pull/378) [@chaichontat](https://github.com/chaichontat)
...
## 2026-07-10 {small}`blog`

- 📝 Scaling anndata training to the terabyte scale with annbatch [PR](https://github.com/laminlabs/lamin-blog/pull/47) [@felix0097](https://github.com/felix0097)

## 2026-07-08 {small}`hub 1.46.0`
...
- 💄 Pricing page v4: Announce Beta Pro Plan at $10/month and spell out collaborator tiers [PR](https://github.com/laminlabs/laminhub-public/pull/375) [@Ebad371](https://github.com/Ebad371)
- 💄 Support tagging records with emojis [PR](https://github.com/laminlabs/laminhub-public/pull/372) [@sunnyosun](https://github.com/sunnyosun)

## 2026-07-07 {small}`R 1.3.1`

- 🚸 Support path detection in R Jupyter notebooks [PR](https://github.com/laminlabs/laminr/pull/264) [@lazappi](https://github.com/lazappi)
- 🚸 Enable wrapping python arguments with leading underscores [PR](https://github.com/laminlabs/laminr/pull/268) [@Koncopd](https://github.com/Koncopd)

## 2026-07-06 {small}`hub 1.45.0`
...
- 🚸 Use project-aware sheet default names [PR](https://github.com/laminlabs/laminhub-public/pull/368) [@chaichontat](https://github.com/chaichontat)
...
- ♻️ Refactor internals of the API interface [PR](https://github.com/laminlabs/nf-lamin/pull/174) [@rcannood](https://github.com/rcannood)
- ⚗️ Add stress testing workflow [PR](https://github.com/laminlabs/nf-lamin/pull/175) [@rcannood](https://github.com/rcannood)

## 2026-06-29 {small}`db 2.7.0`

Features:

- ✨ Recognize `schema.index` in the `Record` API [PR](https://github.com/laminlabs/lamindb/pull/3736) [@sunnyosun](https://github.com/sunnyosun)
...
- 🚸 Throw an error if categorical values would be read from `RecordJson` [PR](https://github.com/laminlabs/lamindb/pull/3757) [@ishitajain9717](https://github.com/ishitajain9717)
...
- 🚸 Add validation check for union dtypes [PR](https://github.com/laminlabs/lamindb/pull/3743) [@ishitajain9717](https://github.com/ishitajain9717)
- 🚸 Expose `Transform.from_path()` [PR](https://github.com/laminlabs/lamindb/pull/3759) [@falexwolf](https://github.com/falexwolf)
- 🚸 Display run URL instead of transform URL [PR](https://github.com/laminlabs/lamindb/pull/3758) [@falexwolf](https://github.com/falexwolf)
...
- 🚸 Speed up some CLI commands via the hub REST API [PR](https://github.com/laminlabs/lamin-cli/pull/227) [@fredericenard](https://github.com/fredericenard)
- 🚸 Catch `NoWriteAccess` in CLI [PR](https://github.com/laminlabs/lamindb/pull/3761) [@falexwolf](https://github.com/falexwolf)
- 🚸 Catch `CurrentInstanceNotConfigured` in CLI [PR](https://github.com/laminlabs/lamin-cli/pull/232) [@falexwolf](https://github.com/falexwolf)

Performance:

- ⚡️ Speed up `Record.from_dataframe()` by a factor ~2 [PR](https://github.com/laminlabs/lamindb/pull/3752) [@ishitajain9717](https://github.com/ishitajain9717)
- ⚡️ Speed up `Record.from_dataframe()` in presence of indexes [PR](https://github.com/laminlabs/lamindb/pull/3767) [@ishitajain9717](https://github.com/ishitajain9717)

Bug fixes:

- 🐛 Fix ambiguous match in `sheet.to_artifact()` for duplicate names [PR](https://github.com/laminlabs/lamindb/pull/3755) [@sunnyosun](https://github.com/sunnyosun)
...
- 🐛 Fix edge cases in version handling [PR](https://github.com/laminlabs/lamindb/pull/3733) [@Koncopd](https://github.com/Koncopd)
...
- 🔥 Remove backward compat for legacy `ln.Param` call pattern from v1 [PR](https://github.com/laminlabs/lamindb/pull/3729) [@falexwolf](https://github.com/falexwolf)

Docs:

- 📝 Add `space` and `branch` arguments to signatures [PR](https://github.com/laminlabs/lamindb/pull/3741) [@ishitajain9717](https://github.com/ishitajain9717)
- 📝 More clearly document dynamic registries [PR](https://github.com/laminlabs/lamindb/pull/3735) [@falexwolf](https://github.com/falexwolf)
...
- 🐛 Keep sheets editable with union dtype columns [PR](https://github.com/laminlabs/laminhub-public/pull/364) [@chaichontat](https://github.com/chaichontat)
...
- ✨ Pricing page v3: Add a preview of the upcoming Pro plan [PR](https://github.com/laminlabs/laminhub-public/pull/352) [@Ebad371](https://github.com/Ebad371)
...
For details see the [Compatibility Matrix](https://docs.lamin.ai/setup#compatibility-matrix) and the [source code](https://github.com/laminlabs/lamindb/tree/30efe8db82bd7a881246492a90f5c61114589081/lamindb/migrations).
...
- 🚸 Store `index`-like features in the `name` field of `Record` [PR](https://github.com/laminlabs/lamindb/pull/3716) [@sunnyosun](https://github.com/sunnyosun)
...
- 🚸 Improve typing of `Feature()` constructor [PR](https://github.com/laminlabs/lamindb/pull/3708) [@ishitajain9717](https://github.com/ishitajain9717)
- 🚸 Upon exporting records, link each single record as an input rather than their type, always link record exports against a run of `__lamindb_record_export__` [PR1](https://github.com/laminlabs/lamindb/pull/3707) [PR2](https://github.com/laminlabs/lamindb/pull/3723) [PR3](https://github.com/laminlabs/lamindb/pull/3710) [@falexwolf](https://github.com/falexwolf)
...
- 📝 Refer to `SQLRecord` types as (dynamic) registries [PR](https://github.com/laminlabs/lamindb/pull/3721) [@falexwolf](https://github.com/falexwolf)
- 📝 Advocate feature objects over feature names [PR](https://github.com/laminlabs/lamindb/pull/3720) [@falexwolf](https://github.com/falexwolf)
...
- 🚸 Better design for the space selector [PR](https://github.com/laminlabs/laminhub-public/pull/343) [@chaichontat](https://github.com/chaichontat)
- 🚸 Better design for artifacts filter sidebar [PR](https://github.com/laminlabs/laminhub-public/pull/345) [@falexwolf](https://github.com/falexwolf)
...
- 🐛 Populate `run.finished_at` for transfer and export functions [PR](https://github.com/laminlabs/lamindb/pull/3706) [@falexwolf](https://github.com/falexwolf)
...
Given a file or folder is _already present_ in a managed storage location when passing an S3 path to `Artifact()`, the constructor will no longer attempt deduplicating it (`skip_hash_lookup = True`).
...
See [PR](https://github.com/laminlabs/lamindb/pull/3700) [@Koncopd](https://github.com/Koncopd)

:::

:::{dropdown} ⚠️ Drop support for passing semantic type names in v1 string-based dtypes.
...
See [PR](https://github.com/laminlabs/lamindb/pull/3697) [@falexwolf](https://github.com/falexwolf)
...
- ✨ Allow changing the real storage key by moving the artifact within the storage location [PR1](https://github.com/laminlabs/lamindb/pull/3673) [PR2](https://github.com/laminlabs/lamindb/pull/3665) [@Koncopd](https://github.com/Koncopd)
...
- ✨ Use existing artifacts for `s3` and `gs` paths in `.lamindb/` when creating an artifact [PR](https://github.com/laminlabs/lamindb/pull/3691) [@Koncopd](https://github.com/Koncopd)
- ✨ Add public `key_is_virtual` argument to `Artifact(...)` [PR](https://github.com/laminlabs/lamindb/pull/3684) [@Koncopd](https://github.com/Koncopd)
...
- 🚸 Clearer error on reading old versions of artifacts with `overwrite_versions=True` [PR](https://github.com/laminlabs/lamindb/pull/3679) [@Koncopd](https://github.com/Koncopd)
- 🚸 Improve the UX around auto-selecting managed storage locations for a space [PR](https://github.com/laminlabs/lamindb/pull/3677) [@falexwolf](https://github.com/falexwolf)
- 🚸 Show login confirmation [PR](https://github.com/laminlabs/lamindb-setup/pull/1335) [@Koncopd](https://github.com/Koncopd)
- 🚸 Raise an informative error for unmanaged storages in storage settings setters [PR](https://github.com/laminlabs/lamindb/pull/3681) [@Koncopd](https://github.com/Koncopd)
...
- 🚸 Add safeguards against non-latest `revises` argument on saving a versioned sqlrecord [PR](https://github.com/laminlabs/lamindb/pull/3685) [@Koncopd](https://github.com/Koncopd)
...
- 📝 More visibility for branching on the `manage-changes` document [PR](https://github.com/laminlabs/lamindb/pull/3688) [@falexwolf](https://github.com/falexwolf)
...
- ✨ Run general Python scripts from the `Transforms` tab [PR](https://github.com/laminlabs/laminhub-public/pull/336) [@sheetalgiri](https://github.com/sheetalgiri)
...
- 🐛 Fix key resolution; deprecate uploading local paths [PR](https://github.com/laminlabs/nf-lamin/pull/157) [@rcannood](https://github.com/rcannood)
- ♻️ Add support for Nextflow 26.04 [PR](https://github.com/laminlabs/nf-lamin/pull/154) [@rcannood](https://github.com/rcannood)
- 🎨 Uniformise redaction of sensitive information [PR](https://github.com/laminlabs/nf-lamin/pull/153) [@rcannood](https://github.com/rcannood)

## 2026-05-17 {small}`hub 1.36.0`
...
- 🚸 Clear search on folder navigation in bucket table [PR](https://github.com/laminlabs/laminhub-public/pull/325) [@chaichontat](https://github.com/chaichontat)
- 🐛 Fix space selector in sheet creation [PR](https://github.com/laminlabs/laminhub-public/pull/326) [@chaichontat](https://github.com/chaichontat)

## 2026-05-06 {small}`nf 0.7.0`

- ✨ Support federated tokens for input files [PR](https://github.com/laminlabs/nf-lamin/pull/148) [@rcannood](https://github.com/rcannood)
- ♻️ Refactor artifact creation [PR](https://github.com/laminlabs/nf-lamin/pull/149) [@rcannood](https://github.com/rcannood)
- ♻️ Refactor testing setup [PR](https://github.com/laminlabs/nf-lamin/pull/150) [@rcannood](https://github.com/rcannood)
...
- 🚸 Experiment page launch improvements [PR](https://github.com/laminlabs/laminhub-public/pull/322) [@chaichontat](https://github.com/chaichontat)
- 🐛 Fix sorting and pagination in access management pages [PR](https://github.com/laminlabs/laminhub-public/pull/324) [@chaichontat](https://github.com/chaichontat)
...
- 🚸 Add a dedicated project page [PR](https://github.com/laminlabs/laminhub-public/pull/321) [@falexwolf](https://github.com/falexwolf)
...
- 🚸 Support more data types in the feature creation modal [PR](https://github.com/laminlabs/laminhub-public/pull/317) [@chaichontat](https://github.com/chaichontat) [@falexwolf](https://github.com/falexwolf)
...
- 🚸 Improve sheet keyboard handling [PR](https://github.com/laminlabs/laminhub-public/pull/306) [@chaichontat](https://github.com/chaichontat)
- 🚸 Standardize instance settings and org collab settings [PR](https://github.com/laminlabs/laminhub-public/pull/304) [@chaichontat](https://github.com/chaichontat)
- 🚸 Canonical run URLs [PR](https://github.com/laminlabs/laminhub-public/pull/303) [@falexwolf](https://github.com/falexwolf)
- 🚸 Transform link inheritance [PR](https://github.com/laminlabs/laminhub-public/pull/307) [@chaichontat](https://github.com/chaichontat)
- 🐛 Fix audit log rendering [PR](https://github.com/laminlabs/laminhub-public/pull/309) [@chaichontat](https://github.com/chaichontat)
- 🐛 Fix double scroll bars in the transform page [PR](https://github.com/laminlabs/laminhub-public/pull/308) [@chaichontat](https://github.com/chaichontat)

## 2026-04-24 {small}`nf 0.6.2`

- 🐛 Defer param evaluation [PR](https://github.com/laminlabs/nf-lamin/pull/145) [@rcannood](https://github.com/rcannood)
- 🐛 Fix include_paths for output artifacts [PR](https://github.com/laminlabs/nf-lamin/pull/142) [@rcannood](https://github.com/rcannood)
- 📝 Clean up documentation [PR](https://github.com/laminlabs/nf-lamin/pull/146) [@rcannood](https://github.com/rcannood)

## 2026-04-23 {small}`blog`
...
## 2026-04-23 {small}`bionty 2.4.0`

:::{dropdown} ⚠️ Run `bionty.core.sync_public_sources()`

This will update the `Source` registry with the new organisms of `Protein`.

:::

- 🍱 9 new organisms from `Uniprot`, `v2026-01` [PR](https://github.com/laminlabs/bionty/pull/371) [@sunnyosun](https://github.com/sunnyosun) [@ishitajain9717](https://github.com/ishitajain9717)
- 🍱 Update `Uniprot` to `v2026-01` for organisms `human` & `mouse` [PR](https://github.com/laminlabs/bionty/pull/370) [@sunnyosun](https://github.com/sunnyosun)

## 2026-04-23 {small}`db 2.4.1`
...
- 🚸 Validated transfer of artifacts to other storage locations [PR](https://github.com/laminlabs/lamindb/pull/3657) [@Koncopd](https://github.com/Koncopd)
- 🐛 Fix cleanup of internal files on instance init failures [PR](https://github.com/laminlabs/lamindb-setup/pull/1332) [@Koncopd](https://github.com/Koncopd)

## 2026-04-21 {small}`hub 1.29.2`

- 🚸 Sheets: bulk row addition and CSV template download [PR](https://github.com/laminlabs/laminhub-public/pull/301) [@chaichontat](https://github.com/chaichontat)
- 🐛 Fix projects page highlighting and pagination [PR](https://github.com/laminlabs/laminhub-public/pull/302) [@chaichontat](https://github.com/chaichontat)
...
- ⬇️ Upgrade and upper bound `s3fs` by 2026.1.0 [PR1](https://github.com/laminlabs/lamindb-setup/pull/1315) [PR2](https://github.com/laminlabs/lamindb/pull/3654) [@Koncopd](https://github.com/Koncopd) [@danplischke](https://github.com/danplischke)
...
## 2026-04-15 {small}`blog`

- 📝 Managing spatial omics datasets with SpatialData & LaminDB [PR](https://github.com/laminlabs/lamin-blog/pull/34) [@Zethson](https://github.com/Zethson)
...
## 2026-04-02 {small}`blog`

- 📝 An introduction to LaminR [PR](https://github.com/laminlabs/lamin-blog/pull/44) [@falexwolf](https://github.com/falexwolf)
