...
- 🚸 `lamin init` now creates an instance in the current directory and auto-connects there and in subdirectories (like `git init`), instead of a single global instance; default storage is `./storage/` [PR](https://github.com/laminlabs/lamindb/pull/3864) [PR](https://github.com/laminlabs/lamin-cli/pull/262) [PR](https://github.com/laminlabs/lamindb-setup/pull/1383) [@falexwolf](https://github.com/falexwolf)

Features:

- ✨ Add `lamin settings mount` to mount storage locations read-only [PR](https://github.com/laminlabs/lamin-cli/pull/257) [@jpfeuffer](https://github.com/jpfeuffer)
...
- 🚸 Make the default record writing space consistent with the UI [PR](https://github.com/laminlabs/lamindb/pull/3844) [@sunnyosun](https://github.com/sunnyosun)
...
- 🐛 Fix finding objects in merge commits [PR](https://github.com/laminlabs/lamindb/pull/3861) [@ishitajain9717](https://github.com/ishitajain9717)
- 🐛 Import `Unset` in `models/schema.py` [PR](https://github.com/laminlabs/lamindb/pull/3862) [@harshadkhetpal](https://github.com/harshadkhetpal)
...
- 🐛 Fix a bug in feature predicate detection [PR](https://github.com/laminlabs/lamindb/pull/3858) [@falexwolf](https://github.com/falexwolf)
...
- 📝 Fix two typos in pydantic-pandera FAQ [PR](https://github.com/laminlabs/lamindb/pull/3869) [@vaibhav8a](https://github.com/vaibhav8a)
