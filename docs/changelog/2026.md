...
- ✨ Pull existing artifacts for `s3` and `gs` paths in `.lamindb/` when creating an artifact [PR](https://github.com/laminlabs/lamindb/pull/3691) [@Koncopd](https://github.com/Koncopd)
...
- 🚸 No longer attempt deduplicating existing artifacts in storage  [PR](https://github.com/laminlabs/lamindb/pull/3700) [@Koncopd](https://github.com/Koncopd)
