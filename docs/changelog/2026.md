...
- 🚸 Change the default storage location for `lamin init` / `init()` to `./storage` and write a local `current_instance` file (`dev-dir`) instead of one in the HOME directory [PR](https://github.com/laminlabs/lamin-cli/pull/262) [PR](https://github.com/laminlabs/lamindb-setup/pull/1383) [@falexwolf](https://github.com/falexwolf)
