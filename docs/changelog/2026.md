...
## Soon {small}`db 2.10.1`

- 🚸 Allow passing `store_kwargs` for `lamin save` on artifacts [PR](https://github.com/laminlabs/lamin-cli/pull/265) [@Koncopd](https://github.com/Koncopd)
