...
| -------------------- | --------------- | ---------------------------- | ------------------- |
| Tracked decorator    | `@ln.tracked()` | `@ln.flow()`, `@ln.step()`   | ✓                   |
| `Feature` field      | `dtype`         | `_dtype_str`                 | ✓                   |
| `Schema` field       | `n`             | `n_members` (`IntegerField`) | ✓                   |
| `IsVersioned` field  | `version`       | `version_tag`                | ✓                   |
| `Transform` field    | `type`          | `kind`                       | ✓                   |
| `FeatureValue` model | `FeatureValue`  | `JsonValue`                  | ✓                   |
| `Artifact` field     | `feature_sets`  | `schemas`                    | ✓                   |
| `Feature` field      | `coerce_dtype`  | `coerce` (`BooleanField`)    | ✓                   |
| `Schema` field       | `coerce_dtype`  | `coerce` (`BooleanField`)    | ✓                   |
