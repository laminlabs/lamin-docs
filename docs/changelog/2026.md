...
- 🔊 Give more information on failing to insert an instance record into hub during instance initialization [PR](https://github.com/laminlabs/lamindb-setup/pull/1283) [@Koncopd](https://github.com/Koncopd)
