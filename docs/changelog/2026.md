...
- ✨ Move artifact within the storage on changes of a real storage key or suffix [PR1](https://github.com/laminlabs/lamindb/pull/3673) [PR2](https://github.com/laminlabs/lamindb/pull/3665) [@Koncopd](https://github.com/Koncopd)
...
- ✨ Add public `key_is_virtual` argument to `Artifact.__init__(...)` [PR](https://github.com/laminlabs/lamindb/pull/3684) [@Koncopd](https://github.com/Koncopd)
