...
- 🚚 More consistent switch and create commands [PR](https://github.com/laminlabs/lamin-cli/pull/187) [@falexwolf](https://github.com/falexwolf)
...
- 📝 Consistently mention backward relationships and type-annotate `ManyToMany` fields with `RelatedManager[T]` [PR](https://github.com/laminlabs/lamindb/pull/3474) [PR](https://github.com/laminlabs/lamindb/pull/3496) [@falexwolf](https://github.com/falexwolf)
