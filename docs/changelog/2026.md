...
## 2026-04-23 {small}`db 2.4.1 | bionty 2.4.0`
...
- ⬆️ Support 9 new organisms for `Protein` [PR](https://github.com/laminlabs/bionty/pull/371) [@sunnyosun](https://github.com/sunnyosun)

:::{dropdown} ⚠️ Run `bionty.core.sync_public_sources()` after updating
