...
## 2025-05-02 {small}`db 1.5.0 | bionty 1.3.2`

Data lineage.

- 🚸 Enable passing the 12-char stem uid to `ln.track()`, detect renames of notebooks [PR](https://github.com/laminlabs/lamindb/pull/2718) [@falexwolf](https://github.com/falexwolf)
...
- 🚸 Automatically pass validation of ensembl gene IDs & ✨ add curator **repr** [PR](https://github.com/laminlabs/lamindb/pull/2742) [@Zethson](https://github.com/Zethson)
...
- 🚸 Restore validation error messages & add their fine-grained testing [PR](https://github.com/laminlabs/lamindb/pull/2709) [@falexwolf](https://github.com/falexwolf)
- 🚚 Rename the `components` keyword argument of `Schema()` to `slots` [PR](https://github.com/laminlabs/lamindb/pull/2727) [@falexwolf](https://github.com/falexwolf)
