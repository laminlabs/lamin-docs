...
## 2025-03-26 {small}`db 1.3.1`

Bug fixes:

`gotrue==2.12.0` broke `lamin login` CLI command. This incompatibility is fixed in this release.

- 🐛 Fix gotrue incompatibility by using pyjwt to decode access_token [PR](https://github.com/laminlabs/lamindb-setup/pull/1008) [@Koncopd](https://github.com/Koncopd)
