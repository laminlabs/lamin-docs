...
- ♻️ Isolate functions that make CLI calls so they do not interfere with the main session/environment [PR](https://github.com/laminlabs/laminr/pull/201) [@lazappi](https://github.com/lazappi)
...
- ♻️ Save a simplified R environment file when `ln$finish()` is called instead of a **{pak}** lockfile [PR](https://github.com/laminlabs/laminr/pull/213) [@lazappi](https://github.com/lazappi)
