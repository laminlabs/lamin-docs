...
## 2025-11-17 {small}`hub 1.0`

LaminHub is a data collaboration hub built on LaminDB, similar to how GitHub is built on git. On one platform, you get: lakehouse, lineage, feature store, ontologies, LIMS, and ELN.

You retain full admin access through the open-source core, enabling zero lock-in and much higher control over your data than if it was locked away behind a custom REST. For instance, you can work directly with Postgres & diverse storage formats on AWS S3 to build scalable learning organizations and applications. This is possible because LaminHub connects databases and storage locations in their host data centers where you run your compute loads. Most functionality is available for AWS data centers, with support for other cloud providers and fully on-prem solutions also possible.

[@fredericenard](https://github.com/fredericenard) built the backend and infrastructure. [@Richard](https://github.com/chaichontat) built the frontend.

Other contributors include: [@Koncopd](https://github.com/Koncopd), [@awgaan](https://github.com/awgaan), [@alexras](https://github.com/alexras), [@sunnyosun](https://github.com/sunnyosun), and [@falexwolf](https://github.com/falexwolf).
