...
You retain full admin access through the open-source core, enabling zero lock-in and higher control over your data than over a rate-limited REST. For instance, you can work directly with Postgres & diverse storage formats on AWS S3 to build scalable learning organizations and applications. This is possible because LaminHub connects databases and storage locations in their host data centers where you run your compute loads. Most functionality is available for AWS data centers, with support for other cloud providers and fully on-prem solutions also possible.
...
They had help from: [@Koncopd](https://github.com/Koncopd), [@awgaan](https://github.com/awgaan), [@alexras](https://github.com/alexras), [@sunnyosun](https://github.com/sunnyosun), and [@falexwolf](https://github.com/falexwolf).
