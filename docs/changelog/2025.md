...
## 2025-12-16 {small}`hub 1.5.2`

- 🐛 Fix ancestry resolution for nested `Record[...]` dtypes [PR](https://github.com/laminlabs/laminhub-public/pull/163) [@chaichontat](https://github.com/chaichontat)
...
## 2025-12-15 {small}`hub 1.5.1`

- 🐛 Enforce branch code filter also when `showAll=true` [PR](https://github.com/laminlabs/laminhub-public/pull/161) [@chaichontat](https://github.com/chaichontat)
- 🐛 Access tables now show a loading state [PR](https://github.com/laminlabs/laminhub-public/pull/160) [@chaichontat](https://github.com/chaichontat)
- ⚡️ Faster load for instance collaborators [PR](https://github.com/laminlabs/laminhub-public/pull/159) [@chaichontat](https://github.com/chaichontat)

## 2025-12-14 {small}`db 1.17.0`
...
For details see the [Compatibility Matrix](https://docs.lamin.ai/setup#compatibility-matrix) and the [source code](https://github.com/laminlabs/lamindb/tree/fdb34283371ef366df0d96086381d6a081b3bd46/lamindb/migrations).

:::

LaminDB instances can now easily be snapshot as an SQLite file. We leverage this to provide `https` access to clones of public instances that are hosted on S3, avoiding firewall-related time outs if the Postgres-protocol or ports are blacklisted and generally improving latency of queries.

- ✨ Add `ln.DB` to conveniently query all entities in any instance [PR](https://github.com/laminlabs/lamindb/pull/3314) [@Zethson](https://github.com/Zethson)
...
More convenient access to feature values:
...
- 🚸 Enable queries to other instances also in case no default instance is configured [PR](https://github.com/laminlabs/lamindb/pull/3359) [@Koncopd](https://github.com/Koncopd)
- 🚸 Introduce `.describe()` on all `BaseSQLRecord` objects and classes + on `QuerySet` [PR](https://github.com/laminlabs/lamindb/pull/3373) [@falexwolf](https://github.com/falexwolf)
...
- 🚸 No more warning about not being connected given `ln.DB()` now exists [PR](https://github.com/laminlabs/lamindb-setup/pull/1235) [@falexwolf](https://github.com/falexwolf)
...
- 🚸 Be more strict about constraining types in `HasType` [PR](https://github.com/laminlabs/lamindb/pull/3295) [@falexwolf](https://github.com/falexwolf)
...
- 🚸 Better handle `organism` constraints where they are needed, default to `bt.settings.organism = None` [PR](https://github.com/laminlabs/lamindb/pull/3356) [@sunnyosun](https://github.com/sunnyosun)
...
- 🚸 Better name for `record.type_to_dataframe()`: `record.to_dataframe()` [PR](https://github.com/laminlabs/lamindb/pull/3333) [@falexwolf](https://github.com/falexwolf)
- 🗃️ Add an `extra_data` JSON field to `Record` [PR](https://github.com/laminlabs/lamindb/pull/3318) [@falexwolf](https://github.com/falexwolf)
...
- 🐛 In sheet export, do not limit to just 100 records [PR](https://github.com/laminlabs/lamindb/pull/3323) [@falexwolf](https://github.com/falexwolf)
- ♻️ Allow `__lamindb_...` type columns in sheet export also if `schema.maximal_set = True` [PR](https://github.com/laminlabs/lamindb/pull/3367) [@falexwolf](https://github.com/falexwolf)

General UX:

- ⚡️ Faster `lamin init` from compressed SQLite file [PR](https://github.com/laminlabs/lamindb/pull/3340) [@ap--](https://github.com/ap--) [@falexwolf](https://github.com/falexwolf)
...
- 🚸 Clarify DB vendor vs. dialect [PR](https://github.com/laminlabs/lamindb-setup/pull/1226) [@falexwolf](https://github.com/falexwolf)
...
- 🐛 Honor `dev-dir` in `lamin save` [PR](https://github.com/laminlabs/lamindb/pull/3300) [@falexwolf](https://github.com/falexwolf)
...
- ♻️ Allow skipping to mark the storage root when registering a storage [PR](https://github.com/laminlabs/lamindb/pull/3303) [@Koncopd](https://github.com/Koncopd)
...
- ♻️ Add `LAMIN_S3_ANON` env variable to force `anon` mode for all non-managed s3 buckets [PR](https://github.com/laminlabs/lamindb-setup/pull/1221) [@Koncopd](https://github.com/Koncopd)
...
- ♻️ Adapt code to rate limiting initialization of instances [PR](https://github.com/laminlabs/lamindb-setup/pull/1227) [@Koncopd](https://github.com/Koncopd)
- ♻️ Remove logic that checks admin permissions client side before migrate step [PR](https://github.com/laminlabs/lamindb-setup/pull/1218) [@falexwolf](https://github.com/falexwolf)
- ♻️ Corrections and clarifications for `get_parents()` [PR](https://github.com/laminlabs/lamindb/pull/3320) [@Koncopd](https://github.com/Koncopd)
- ♻️ Harmonize lineage graph display [PR](https://github.com/laminlabs/lamindb/pull/3313) [@falexwolf](https://github.com/falexwolf)

Dependencies:

- ➕ Add `pgtrigger` [PR](https://github.com/laminlabs/lamindb-setup/pull/1212) [@falexwolf](https://github.com/falexwolf)
- ⬇️ Upper bound for pandas 3 [PR](https://github.com/laminlabs/lamindb/pull/3335) [@Zethson](https://github.com/Zethson)

Independent tests:

- ✅ Also run core unit tests against an SQLite database, not just against Postgres [PR](https://github.com/laminlabs/lamindb/pull/3310) [@falexwolf](https://github.com/falexwolf)
...
- 🐛 Reject empty non-nullable features with dtype `list[...]` [PR](https://github.com/laminlabs/laminhub-public/pull/154) [@chaichontat](https://github.com/chaichontat)
- 🐛 Fix edge cases in the S3 storage metadata endpoint [PR](https://github.com/laminlabs/laminhub-public/pull/150) [@chaichontat](https://github.com/chaichontat)
- 🐛 Skip existing transform name validation [PR](https://github.com/laminlabs/laminhub-public/pull/146) [@chaichontat](https://github.com/chaichontat)
...
## 2025-12-04 {small}`hub 1.4.1`

- 🐛 Fix populating sheets from transforms in presence of list dtypes [PR](https://github.com/laminlabs/laminhub-public/pull/140) [@chaichontat](https://github.com/chaichontat)
...
- 🐛 Fix list feature parsing from function response [PR](https://github.com/laminlabs/laminhub-public/pull/138) [@sunnyosun](https://github.com/sunnyosun)
...
## 2025-12-02 {small}`hub 1.3.1`

- 🐛 Fix data propagation in `dtype` `list` fields [PR](https://github.com/laminlabs/laminhub-public/pull/134) [@chaichontat](https://github.com/chaichontat)

## 2025-12-02 {small}`hub 1.3.0`
...
## 2025-12-01 {small}`nf 0.2.2`

- ✨ Add `getInstanceSlug()` function [PR](https://github.com/laminlabs/nf-lamin/pull/112) [@rcannood](https://github.com/rcannood)
- ✨ Allow fetching artifact paths from UID with `getArtifactFromUid` [PR](https://github.com/laminlabs/nf-lamin/pull/96) [@hcannoodt](https://github.com/hcannoodt)
...
- 🐛 Fix some failed runs being marked as successful [PR](https://github.com/laminlabs/nf-lamin/pull/110) [@rcannood](https://github.com/rcannood)
...
- 🐛 Fix provider in build config [PR](https://github.com/laminlabs/nf-lamin/pull/98) [@rcannood](https://github.com/rcannood)

## 2025-12-01 {small}`hub 1.2.0`

- ✨ Support display of list `dtype` in Records [PR](https://github.com/laminlabs/laminhub-public/pull/128) [@chaichontat](https://github.com/chaichontat)
- 🚸 On `Launch` page, consolidate buttons and allow dialogs to fill page [PR](https://github.com/laminlabs/laminhub-public/pull/132) [@chaichontat](https://github.com/chaichontat)
...
- 🚸 On `Launch` page, set initial artifact filter to schema name [PR](https://github.com/laminlabs/laminhub-public/pull/129) [@chaichontat](https://github.com/chaichontat)
...
## 2025-11-27 {small}`hub 1.1.1`

- 🐛 Preserve column name `__lamindb_record_name__` in csv upload [PR](https://github.com/laminlabs/laminhub-public/pull/127) [@chaichontat](https://github.com/chaichontat)

## 2025-11-26 {small}`hub 1.1.0`

- ✨ Directly load artifacts and files into sheets [PR](https://github.com/laminlabs/laminhub-public/pull/126) [@chaichontat](https://github.com/chaichontat)
- ✨ Support executable transform UIDs [PR](https://github.com/laminlabs/laminhub-public/pull/125) [@chaichontat](https://github.com/chaichontat)
- ✨ Recognize column name `__lamindb_record_name__` in csvs to indicate record names for sheet imports [PR](https://github.com/laminlabs/laminhub-public/pull/124) [@chaichontat](https://github.com/chaichontat)
- 🚸 Auto-filename generation for uploads [PR](https://github.com/laminlabs/laminhub-public/pull/121) [@chaichontat](https://github.com/chaichontat)
- 🚸 Improve visual distinction between optional and required features for a schema [PR](https://github.com/laminlabs/laminhub-public/pull/120) [@chaichontat](https://github.com/chaichontat)
...
:::{dropdown} Incremental changes since `0.52.0`
...
## 2025-11-19 {small}`hub 0.51.0`

- 🚸 Implement collapsible sections for `Launch` page [PR](https://github.com/laminlabs/laminhub-public/pull/109) [@chaichontat](https://github.com/chaichontat)
- 🐛 Fix editing context in quick mode on `Launch` page [PR](https://github.com/laminlabs/laminhub-public/pull/110) [@chaichontat](https://github.com/chaichontat)

## 2025-11-18 {small}`hub 0.50.0`

- 🚸 Select artifacts in transform execute [PR](https://github.com/laminlabs/laminhub-public/pull/108) [@chaichontat](https://github.com/chaichontat)
- 🚸 Better annotation definition in the `Schema` page [PR](https://github.com/laminlabs/laminhub-public/pull/107) [@chaichontat](https://github.com/chaichontat)

## 2025-11-17 {small}`hub 0.49.0`
...
- 🚸 Inline form for run metadata [PR](https://github.com/laminlabs/laminhub-public/pull/104) [@chaichontat](https://github.com/chaichontat)
...
- 🐛 Add autoscroll to fill handler [PR](https://github.com/laminlabs/laminhub-public/pull/105) [@chaichontat](https://github.com/chaichontat)
- 🐛 Ensure a new run is visible right after launching it [PR](https://github.com/laminlabs/laminhub-public/pull/103) [@chaichontat](https://github.com/chaichontat)
- 🐛 Fix faceted branch filtering [PR](https://github.com/laminlabs/laminhub-public/pull/102) [@chaichontat](https://github.com/chaichontat)
- 🐛 Prevent a selector from creating new entities through <Enter> [PR](https://github.com/laminlabs/laminhub-public/pull/101) [@chaichontat](https://github.com/chaichontat)
- 🐛 Fix direct links to individual ulabels [PR](https://github.com/laminlabs/laminhub-public/pull/100) [@chaichontat](https://github.com/chaichontat)

## 2025-11-16 {small}`hub 0.48.0`

- 🚸 Create a tooltip to help orient the user in the "Create record" dialogue [PR](https://github.com/laminlabs/laminhub-public/pull/87) [@chaichontat](https://github.com/chaichontat)
- 🚸 Auto-select unique transforms during sheet generation [PR](https://github.com/laminlabs/laminhub-public/pull/88) [@chaichontat](https://github.com/chaichontat)
...
- ✨ Make it easy to re-run scripts by tracking `cli_args` [PR](https://github.com/laminlabs/lamindb/pull/3278) [@falexwolf](https://github.com/falexwolf)

UX:

- 🚸 Pass `string` to `from_source()` for look up across all semantic fields, no longer do that upon passing `name` or any other specific field [PR](https://github.com/laminlabs/lamindb/pull/3273) [@sunnyosun](https://github.com/sunnyosun)
- 🚸 Enable passing a list of record objects to `record.features.add_values()` [PR](https://github.com/laminlabs/lamindb/pull/3266) [@falexwolf](https://github.com/falexwolf)

Bug fixes:

- 🐛 More scalable `query_children()` and `query_parents()` [PR](https://github.com/laminlabs/lamindb/pull/3265) [@Koncopd](https://github.com/Koncopd)

Deprecations:

- 🚚 Deprecate `Registry.using()` in favor of `Registry.connect()` [PR](https://github.com/laminlabs/lamindb/pull/3280) [@falexwolf](https://github.com/falexwolf)
...
- 🚚 Deprecate `itype='Composite'` [PR](https://github.com/laminlabs/lamindb/pull/3268) [@falexwolf](https://github.com/falexwolf)
...
- ♻️ Refactor `artifact` tests [PR](https://github.com/laminlabs/lamindb/pull/3274) [@falexwolf](https://github.com/falexwolf)
...
## 2025-11-05 {small}`db 1.15.2`

Note: `v1.15.1` had an unnecessary print statement, producing unexpected logs in `to_dataframe(include="features")`.

Bug fixes.

- 🐛 Correctly deal with `None`, `date`, and `datetime` in `record.features.add_values()` [PR](https://github.com/laminlabs/lamindb/pull/3261) [@falexwolf](https://github.com/falexwolf)
...
- 🐛 Reset federated AWS credentials cache after logout or re-login [PR](https://github.com/laminlabs/lamindb-setup/pull/1189) [@Koncopd](https://github.com/Koncopd)
...
- 🚸 Fix anndata version warnings [PR](https://github.com/laminlabs/lamindb/pull/3259) [@Zethson](https://github.com/Zethson)

## 2025-10-30 {small}`db 1.15.0`

Features.

- ✨ Add `Record.features` to conveniently populate features of records [PR1](https://github.com/laminlabs/lamindb/pull/3246) [PR2](https://github.com/laminlabs/lamindb/pull/3248) [@falexwolf](https://github.com/falexwolf)

UX:

- 🚸 Improve the experience of working in a local development directory: `dev-dir` (called `work-dir` in beta) [PR](https://github.com/laminlabs/lamindb/pull/3252) [@falexwolf](https://github.com/falexwolf)
- 🚸 Support external features in `DataFrameCurator` [PR](https://github.com/laminlabs/lamindb/pull/3240) [@falexwolf](https://github.com/falexwolf)
- 🚸 Enable passing `parquet_kwargs` to `Artifact.from_dataframe()` for configuring `pyarrow.ParquetWriter` [PR1](https://github.com/laminlabs/lamindb/pull/3239) [PR2](https://github.com/laminlabs/lamindb/pull/3242) [@falexwolf](https://github.com/falexwolf)
...
- 🚸 More consistent `.to_dataframe()` across `SQLRecord.to_dataframe()` and `QuerySet.to_datafame()`, all now set a default `limit` of 100 and order by latest creation - also, one can now indicate including features via `include="features"` [PR](https://github.com/laminlabs/lamindb/pull/3230) [@falexwolf](https://github.com/falexwolf)
...
- 🚸 Enable `run.describe()` [PR](https://github.com/laminlabs/lamindb/pull/3197) [@falexwolf](https://github.com/falexwolf)
...
- 🐛 Serialize `Iterable` of `SQLRecord` in params tracking [PR](https://github.com/laminlabs/lamindb/pull/3233) [@falexwolf](https://github.com/falexwolf)
...
- 🐛 Fix exporting sheets with features of dtype `User` [PR](https://github.com/laminlabs/lamindb/pull/3221) [@sunnyosun](https://github.com/sunnyosun)
...
- 🐛 Set db tokens for connections in all contexts (threads, tasks), disable task-specific database wrappers in jupyter for ipykernel>=7.0.0 [PR](https://github.com/laminlabs/lamindb/pull/3172) [@Koncopd](https://github.com/Koncopd)
...
- 🏗️ For instances connected to the hub, they can now be migrated through the API [PR](https://github.com/laminlabs/lamindb-setup/pull/1161) [@fredericenard](https://github.com/fredericenard)
...
- ♻️ Add `init_local_sqlite` to create empty copies of existing Postgres instances [PR](https://github.com/laminlabs/lamindb-setup/pull/1149) [@Zethson](https://github.com/Zethson)

Docs:

- 📝 Improve `manage-ontologies` guide [PR](https://github.com/laminlabs/lamindb/pull/3182) [@sunnyosun](https://github.com/sunnyosun)
- 📝 README v4 [PR](https://github.com/laminlabs/lamindb/pull/3216) [@falexwolf](https://github.com/falexwolf)
...
- ✨ Introduce a `work-dir` as a local development directory to organize scripts & notebooks [PR](https://github.com/laminlabs/lamindb/pull/3105) [@falexwolf](https://github.com/falexwolf)
...
## 2025-09-30 {small}`nf 0.2.0`

- ✨ Allow an advanced user to specify the transform and/or run UID in the config [PR](https://github.com/laminlabs/nf-lamin/pull/83) [@rcannood](https://github.com/rcannood)
- ✨ Update run status based on lamindb changes [PR](https://github.com/laminlabs/nf-lamin/pull/73) [@rcannood](https://github.com/rcannood)
...
- 🐛 Fix missing nextflow config [PR](https://github.com/laminlabs/nf-lamin/pull/86) [@rcannood](https://github.com/rcannood)
...
- ⬆️ Upgrade to new nextflow plugin setup [PR](https://github.com/laminlabs/nf-lamin/pull/74) [@rcannood](https://github.com/rcannood)
...
## 2025-06-23 {small}`nf 0.1.0`

- ✨ Track output artifacts and Nextflow runs via transforms and runs [PR](https://github.com/laminlabs/nf-lamin/pull/63) [@rcannood](https://github.com/rcannood)
