...
## 2025-09-09 {small}`db 1.11.0 | bionty 1.7.0 | wetlab 1.5`

Highlights:

Package organization:

- 🏗️ Always import the entire public API & enable switching instances in the same Python session [PR](https://github.com/laminlabs/lamindb/pull/2851) [PR](https://github.com/laminlabs/lamindb-setup/pull/1133) [PR](https://github.com/laminlabs/lamindb-setup/pull/1063) [PR](https://github.com/laminlabs/lamindb/pull/3019) [@falexwolf](https://github.com/falexwolf) [@Koncopd](https://github.com/Koncopd)
- 🏗️ Include wetlab & bionty in lamindb, upgrade to latest versions [PR](https://github.com/laminlabs/lamindb/pull/3063) [@falexwolf](https://github.com/falexwolf)
  - 🏗️ Always import the entire public API in bionty [PR](https://github.com/laminlabs/bionty/pull/319) [@falexwolf](https://github.com/falexwolf)
  - 🏗️ Always import the entire public API in wetlab [PR](https://github.com/laminlabs/wetlab/pull/119) [@falexwolf](https://github.com/falexwolf)
- 🏗️ Pause maintenance of `clinicore` [PR](https://github.com/laminlabs/lamindb/pull/3065) [@falexwolf](https://github.com/falexwolf)

Data validation:

Many data structures that allow storing metadata in dictionaries stored in specific slots like `.attrs` for Pandas DataFrames & SpatialData objects or `.uns` for AnnData and MuData objects can now have such metadata validated.
...
Sometimes additional metadata is not necessarily stored in one of these slots but the dataset should still be annotated with specific metadata, which LaminDB now supports validating as linked features:

```python
import lamindb as ln

df = ln.core.datasets.small_dataset1(otype="DataFrame")
schema = ln.Schema([ln.Feature(name="species", dtype="str").save(),
...
- ✨ Support validating linked features: adding a `schema` argument to `.features.add_values()` [PR](https://github.com/laminlabs/lamindb/pull/3039) [PR](https://github.com/laminlabs/lamindb/pull/3052) [@Zethson](https://github.com/Zethson)

Other features:

- ✨ Soft delete everywhere [PR](https://github.com/laminlabs/lamindb/pull/3022) [@falexwolf](https://github.com/falexwolf) [@Zethson](https://github.com/Zethson)
...
We further overhauled the support for CELLxGENE by moving to a Schema based workflow:

```python
!cellxgene-schema --version # should print 6.0.0
!cellxgene-schema validate dataset.h5ad

import lamindb as ln

cxg_schema = ln.examples.cellxgene.get_cxg_schema(schema_version="6.0.0")
...
- 📝 Refactor CELLxGENE curation guide to being schema-based [PR](https://github.com/laminlabs/cellxgene-lamin/pull/126) [PR](https://github.com/laminlabs/cellxgene-lamin/pull/129) [@Zethson](https://github.com/Zethson)
