...
- 🐛 Fix for failed runs being marked as successful [PR](https://github.com/laminlabs/nf-lamin/pull/110) [@rcannood](https://github.com/rcannood)
...
- 🐛 Fix CI tests after Nextflow and Python releases [PR](https://github.com/laminlabs/nf-lamin/pull/97) [@rcannood](https://github.com/rcannood)
