...
- Add a `lamin_settings()` function that displays information from running `lamin settings` [PR](https://github.com/laminlabs/laminr/pull/201) [@lazappi](https://github.com/lazappi)
- Add a `laminr_status()` function that returns a `laminr_status` object with information useful for debugging.
  This has pretty print output. [PR](https://github.com/laminlabs/laminr/pull/215) [@lazappi](https://github.com/lazappi)
...
- Add `LAMINR_LAMINDB_VERSION` and `LAMINR_LAMINDB_OPTIONS` environment variables to control the version of Python **lamindb** that is installed [PR1](https://github.com/laminlabs/laminr/pull/194) [PR2](https://github.com/laminlabs/laminr/pull/218) [@lazappi](https://github.com/lazappi)
- Add a new `use_temporary_instance()` function to replace `lamin_init_temp()` [PR](https://github.com/laminlabs/laminr/pull/229) [@lazappi](https://github.com/lazappi)

Deprecated code:

- The Lamin CLI functions are now deprecated. Instead, users should import the `lamin_cli` Python module using `import_module("lamin_cli")` and call the functions from there. [PR](https://github.com/laminlabs/laminr/pull/229) [@lazappi](https://github.com/lazappi)
...
- Isolate functions that make CLI calls so they do not interfere with the main session/environment [PR](https://github.com/laminlabs/laminr/pull/201) [@lazappi](https://github.com/lazappi)
- Require instance modules before importing `lamindb` so they should be available [PR](https://github.com/laminlabs/laminr/pull/201) [@lazappi](https://github.com/lazappi)
- Save a simplified R environment file when `ln$finish()` is called instead of a **{pak}** lockfile [PR](https://github.com/laminlabs/laminr/pull/213) [@lazappi](https://github.com/lazappi)
