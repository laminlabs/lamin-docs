...
- ✨ Support validating linked features: adding a `schema` argument to `.features.add_values()` and enable passing feature annotations to `ln.Artifact` [PR](https://github.com/laminlabs/lamindb/pull/3039) [PR](https://github.com/laminlabs/lamindb/pull/3052) [@Zethson](https://github.com/Zethson)
