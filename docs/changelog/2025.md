...
- ✨ Allow setting of wrapped object slots [PR](https://github.com/laminlabs/laminr/pull/188) [@lazappi](https://github.com/lazappi)
- ✨ Enable the `view_lineage()` functionality to properly display lineage graphs [PR](https://github.com/laminlabs/laminr/pull/180) [@lazappi](https://github.com/lazappi)

Major changes.

- 🚸 Update Python dependency management to automatically install dependencies with requiring `install_lamindb()` [PR](https://github.com/laminlabs/laminr/pull/183) [@lazappi](https://github.com/lazappi)
  - `install_lamindb()` is now deprecated and may be removed in future versions

Minor changes.

- 📌 Set minimum {reticulate} dependency `>= 1.38.0` [PR](https://github.com/laminlabs/laminr/pull/158) [@lazappi](https://github.com/lazappi)
...
- Update the feel and structure of the documentation website
  - 📝 Update documentation site to match the main docs website [PR](https://github.com/laminlabs/laminr/pull/159) [@lazappi](https://github.com/lazappi)
...
- 📝 Update the content of the introduction article to match the main documentation site [PR](https://github.com/laminlabs/laminr/pull/188) [@lazappi](https://github.com/lazappi)
- 📝 Update the welcome vignette to point to the main LaminDB documentation website [PR](https://github.com/laminlabs/laminr/pull/190) [@lazappi](https://github.com/lazappi)
...
✨ Enable to define simple schemas that merely enforce a feature identifier type. [PR](https://github.com/laminlabs/lamindb/pull/2668) [@falexwolf](https://github.com/falexwolf)

```python
schema = ln.Schema(itype=ln.Feature).save()  # <-- enforce valid feature identifiers, no need to define specific required features
```

✨ Enable to define optional features on a per-schema level & improve schema hash calculation. [PR](https://github.com/laminlabs/lamindb/pull/2635) [@sunnyosun](https://github.com/sunnyosun)
...
🚸 Enable to query by features & params through `Artifact.filter()` and `Run.filter()`. [Guide](/registries.ipynb#query-datasets-by-features) [PR](https://github.com/laminlabs/lamindb/pull/2671) [@falexwolf](https://github.com/falexwolf)
