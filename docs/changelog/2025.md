...
- ✨ Enable to validate & annotate features _without_ passing them to a schema [PR](https://github.com/laminlabs/lamindb/pull/2668) [@falexwolf](https://github.com/falexwolf)
...
- 🚸 `from_source` no longer returns `None` but throws a `NoResultFound` excepetion if a look up in public ontology fails [PR](https://github.com/laminlabs/lamindb/pull/2628) [@sunnyosun](https://github.com/sunnyosun)
...
- 🚸 Enable plain notebook uploads by making a default run for notebook in case none is found [PR](https://github.com/laminlabs/lamin-cli/pull/127) [@falexwolf](https://github.com/falexwolf)
...
```python
gene = bt.base.Gene(source="ensembl", organism="rabbit", version='release-103')
